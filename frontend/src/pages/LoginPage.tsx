    ...
    <div className="min-h-screen bg-[#070a13] flex flex-col items-center justify-center p-6 relative overflow-hidden">
      ...
      <div className="w-full max-w-md glass-effect rounded-2xl p-8 shadow-2xl relative z-10">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-xs text-gray-500 mt-1">Sign in to resume mock preparations</p>
        </div>

        {isExpired && (
          <div className="mb-5 p-3 rounded-xl bg-yellow-500/10 border border-yellow-500/20 text-yellow-500 text-xs flex items-center space-x-2">
